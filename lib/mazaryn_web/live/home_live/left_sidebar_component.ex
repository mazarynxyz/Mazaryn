          ...
          <div class="flex justify-center items-center">
            <ul>
              <li class="flex align-center items-center mx-2 mb-7">
                <.link
                  navigate={~p(/home)}
                  class="group flex align-center items-start text-base text-gray-500 font-semibold hover:text-blue-500"
                >
                  <i>
                    <svg
            ...
            <ul>
              ...
              <li class="flex align-center items-center mx-2 group">
                <.link
                  ...
                  class="group flex items-center text-base text-[#60616D] font-semibold"
                >
            ...
            <ul>
              <li class="flex align-center items-center group mx-2 mb-7">
                ...
                >
                  ...
                  <div class="leading-6 text-[#60616D] group-hover:text-[#4385F5]">Offers</div>
                </a>
              </li>
              <li class="flex align-center items-center group mx-2 mb-7">
                <a
